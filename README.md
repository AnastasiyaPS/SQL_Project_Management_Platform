...
## CI/CD
Проект содержит GitLab CI/CD pipeline.
Pipeline автоматически поднимает PostgreSQL, создаёт схему базы данных, наполняет её тестовыми данными и проверяет корректность SQL-скриптов.
>>>>>>> ed6a910 (БД - управление проектами)
